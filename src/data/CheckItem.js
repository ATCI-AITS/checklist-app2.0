const CheckItems = {
  OA: [
    ...
    {
      id: "OA-J02",
      description: "路段標線劃設是否適當且連續？（包含路面邊線、車道線、分向限制線、禁止超車線、禁止變換車道線、禁止停車線及禁止臨時停車線）<br/>路段相關標線劃設之組合配置是否適當？（如配合路口路型之槽化線、車道線等相關標線之組合是否考量行車軌跡）",
      asterisk: "no",
    },
    {
      id: "OA-J03",
    ...
    },
    {
      id: "OA-L02",
      description:
        "路段停車格位或允許停車路段的設置是否適當？（若允許停車時，其距離應避免與路口過近）<br/>路段對於車輛之停車（包括機車、公車）是否提供適當地點，以避免對其他道路使用人造成危險？",
      asterisk: "no",
    },
    {
      id: "OA-L03",
      description:
        "路段進出停車位之車輛與車道車流之衝突是否影響甚微？<br/>路段路邊停車的安排是否安全？（平行、對角或垂直）",
      asterisk: "no",
    },
    {
      id: "OA-L04",
...

    {
      id: "OA-O01",
      description:
        "路段對於行人沿道路步行是否提供適當之安全設施（人行道、步道、行人專用道、欄杆等）？<br/>路段人行道是否有使用路緣石、柵欄或植栽隔開？是否有扶手或圍欄來確保行人的安全？",
      asterisk: "no",
    },
    ...
    },
    {
      id: "OA-R05",
      description:
        "路段綠化和植栽是否對用路人造成困擾（例如道路線形）？<br/>路段路邊植栽是否會導致駕駛者持續往曲線方向行駛？",
      asterisk: "yes",
    },
    {
      id: "OA-R06",
  ...
  OB: [
    ...
    },
    {
      id: "OB-F17",
      description:
        "臨近路口停止線上游30公尺內路肩是否小於1公尺，避免被誤用為慢車道？",
      asterisk: "no",
    },
    {
      id: "OB-F19",
    ...
    },
    {
      id: "OB-J02",
      description:
        "臨近路口標線劃設是否適當且連續？（包含路面邊線、車道線、分向限制線、禁止超車線、禁止變換車道線、禁止停車線及禁止臨時停車線）<br/>臨近路口相關標線劃設之組合配置是否適當？（如配合路口路型之槽化線、車道線等相關標線之組合是否考量行車軌跡）",
      asterisk: "no",
    },
    {
      id: "OB-J03",
      description: "臨近路口標誌和標線是否沒有任何的矛盾？",
      asterisk: "no",
    },
    {
      id: "OB-J04",
    ...
    {
      id: "OB-L02",
      description: "臨近路口停車格位或允許停車路段的設置是否適當？（若允許停車時，其距離應避免與路口過近）<br/>臨近路口對於車輛之停車（包括機車、公車）是否提供適當地點，以避免對其他道路使用人造成危險？",
      asterisk: "no",
    },
    {
      id: "OB-L03",
      description: "臨近路口進出停車位之車輛與車道車流之衝突是否影響甚微？<br/>臨近路口路邊停車的安排是否安全？（平行、對角或垂直）",
      asterisk: "no",
    },
    {
      id: "OB-L04",
      description:
        "臨近路口若機車停車位須由人行道進出，剩餘人行寬度是否足夠？停放之機車是否不影響行人通行？",
      asterisk: "no",
    },
    {
      id: "OB-L05",
    ...
    },
    {
      id: "OB-M01",
      description:
        "臨近路口有左轉需求時，是否設置左轉專用道？",
      asterisk: "no",
    },
    {
      id: "OB-M02",
      description:
        "左轉車道配置，於尖峰時段是否足夠容納臨近路口的左轉彎車流？",
      asterisk: "no",
    },
    {
      id: "OB-M03",
    ...
    },
    {
      id: "OB-M13",
      description:
        "臨近路口有右轉需求時，是否設置右轉專用道？",
      asterisk: "no",
    },
    {
      id: "OB-M14",
      description:
        "右轉車道配置，於尖峰時段是否足夠容納臨近路口的右轉彎車流？",
      asterisk: "no",
    },
    {
      id: "OB-M15",
    ...
    },
    {
      id: "OB-R05",
      description:
        "臨近路口綠化和植栽是否對用路人造成困擾（例如道路線形）？<br/>臨近路口路邊植栽是否會導致駕駛者持續往曲線方向行駛？",
      asterisk: "yes",
    },
  ],
  OC: [
    ...
    },
    {
      id: "OC-E06",
      description:
        "路口設置有「停」標線（標誌）或閃光紅燈的支線道，以E05項次檢查左右視距被遮蔽時，若已設置反光鏡輔助，反光鏡設置位置是否適當，是否能見衝突車流？",
      asterisk: "no",
    },
    {
      id: "OC-E07",
    ...
    { id: "OC-F39", description: "交岔路口超過四支交岔？", asterisk: "yes" },
    { id: "OC-F40", description: "交岔路口交角是否小於60度？", asterisk: "yes" },
    {
      id: "OC-F41",
      description:
    ...
    },
    {
      id: "OC-I04",
      description:
        "路口標誌是否有反光或夜間照明？<br/>白天或黑夜，標誌的能見度是否足夠？",
      asterisk: "no",
    },
    {
      id: "OC-I05",
    ...
    },
    {
      id: "OC-J02",
      description:
        "路口標線劃設是否適當且連續？（包含路面邊線、車道線、分向限制線、禁止超車線、禁止變換車道線、禁止停車線及禁止臨時停車線）<br/>路口相關標線劃設之組合配置是否適當？（如配合路口路型之槽化線、車道線等相關標線之組合是否考量行車軌跡）",
      asterisk: "no",
    },
    {
      id: "OC-J03",
    ...
    { id: "OC-J08", description: "路口是否劃設左彎待轉區線？", asterisk: "no" },
    {
      id: "OC-J09",
    ...
    { id: "OC-J16", description: "路口機慢車停等區空間不足", asterisk: "yes" },
    {
      id: "OC-J17",
    ...
    },
    {
      id: "OC-K13",
      description:
        "路口是否有左轉專用時相以及時間長度是否足夠？<br/>路口尖峰時段號誌時制一週期內，時制配置是否能疏解左轉彎車流，使最後一輛左轉車輛可進入下游離開路口？",
      asterisk: "no",
    },
    {
      id: "OC-K14",
    ...
    { id: "OC-M20", description: "路口提供迴轉時是否安全？", asterisk: "no" },
    ...
    },
    {
      id: "OC-R05",
      description:
        "路口綠化和植栽是否對用路人造成困擾（例如道路線形）？<br/>路口路邊植栽是否會導致駕駛者持續往曲線方向行駛？",
      asterisk: "yes",
    },
    {
      id: "OC-R06",
  ...
  OD: [
    ...
    },
    {
      id: "OD-J25",
      description:
        "路口遠端右方若設置有機慢車待轉區，機慢車待轉區占用到橫向直行車流軌跡（停等交叉撞之可能）",
      asterisk: "yes",
    },
    {
      id: "OD-J26",
      description:
        "路口遠端右方若設置有機慢車待轉區，機慢車待轉區占用到對向車道（對向擦撞之可能）",
      asterisk: "yes",
    },
    {
      id: "OD-J27",
      description:
        "路口遠端右方若設置有機慢車待轉區，機慢車待轉區占用到橫向左轉車流軌跡（停等對向擦撞之可能）",
      asterisk: "yes",
    },
    {
      id: "OD-J28",
      description:
        "路口遠端右方若設置有機慢車待轉區，機慢車待轉區占用到橫向右轉車流軌跡（停等對向擦撞之可能）",
      asterisk: "yes",
    },
    {
      id: "OD-J29",
